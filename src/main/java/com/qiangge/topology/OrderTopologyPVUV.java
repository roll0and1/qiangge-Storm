...
import com.qiangge.bolts.OrderGlobalPvUvCounterBolt;
 ...
 */
public class OrderTopologyPVUV {
	public static  void main(String[] args) throws Exception{
		...
		builder.setBolt("PVUVcount",new OrderGlobalPvUvCounterBolt(),1).shuffleGrouping("count");
